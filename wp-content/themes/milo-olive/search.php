	...
	<?php if ( have_posts() ) : ?>
		...
		<?php while ( have_posts() ) : the_post();?>
            ...
            <div class="entry" id="post-<?php the_ID(); ?>">
						...
						<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'rebecca_hawkes' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><h3><?php the_title(); ?>"><?php the_title(); ?></h3></a>
						<div class="meta">
