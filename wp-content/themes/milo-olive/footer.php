...
<p id="copyright">&copy; <?php echo date('Y'); ?> &ndash; <?php echo bloginfo('name'); ?> • <a href="https://www.miloandolive.com/terms-of-use">Terms of Use </a> • <a href="https://www.miloandolive.com/privacy-policy/">Privacy Policy</a> • <a href="https://www.miloandolive.com/accessibility-statement/">Accessibility Statement</a></p>


<?php wp_footer(); ?>
<script>
        (function(d, s, id) { var js, dt = new Date().getTime(), jst = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) return; js = d.createElement(s); js.id = id; js.src = 'https://facebook.chownow.com/static/js/iframe.js?'+dt+'#cid=1092'; jst.parentNode.insertBefore(js, jst); }(document, 'script', 'chownow-js'));
</script>
</body>
</html>
